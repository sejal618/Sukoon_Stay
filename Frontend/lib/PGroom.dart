...
class PG_listing extends StatefulWidget 
{
  const PG_listing({super.key});

  @override
  State<PG_listing> createState() => _PG_listingPageState();
}

class _PG_listingPageState extends State<PG_listing> {
  ...
  Future<void> submitData() async {
    ...
    const url = 'http://192.168.159.119:5000/PGRegister';
